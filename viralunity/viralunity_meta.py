...
def generate_config_file(samples: Dict[str, list], args: Dict[str, Any]) -> None:
    ...
    generator.add_metagenomics_settings(
        ...
        run_minimizer_filter=args.get("run_minimizer_filter", False),
        minimizer_min_distinct=args.get("minimizer_min_distinct", 0),
        minimizer_max_duplication=args.get("minimizer_max_duplication", 0.0),
